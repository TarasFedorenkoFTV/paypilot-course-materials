...
| `docs/mentor-escalation.md` | **для ментора**: студент застряг — сходинки від питання до еталона |
...
| `docs/ui-sweep-report.md` | прохід 14 занять **через інтерфейс**: чи працює процедура лектора |
...
Профілі занять і доменні числа звірені з 17 лонгрідами курсу. Самі лонгріди
в репозиторії не зберігаються — вони належать GoIT/Neoversity і живуть у LMS.
